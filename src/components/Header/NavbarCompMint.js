      ...
      <Navbar className={!showLogo && 'navbarTransparent'} expand="xl" expanded={expanded}>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav>
            <Nav.Item>
              <a  href="/" to="/"
              onClick={() => { setExpanded(false) }} onSetActive={() => setShowLogo(false)} onSetInactive={() => setShowLogo(true)}>
                Home
              </a>
            </Nav.Item>
            <Nav.Item>
              <a activeClass="active" href="/#about" to="/#about" spy={true} hashSpy={true}
            ...
            <Nav.Item>
              <a activeClass="active" href="/#showcase" to="/#showcase" spy={true} hashSpy={true}
            ...
            <Nav.Item>
              <a activeClass="active" href="/#roadmap" to="/#roadmap" spy={true} hashSpy={true}
                duration={1000} offset={53}
                delay={0} saveHashHistory={false} onClick={() => setExpanded(false)}>
                Roadmap
              </a>
